...
\begin{frame}[label={sec:org23e67ac}]{}
\fullcite{EPRINT:AlbBaiDuc16}
\end{frame}

\section{Introduction}
\label{sec:org08df278}
\begin{frame}[label={sec:orgb6b6515}]{NTRUEncrypt}
\begin{description}
...
\begin{frame}[fragile,label={sec:orge0e2de7}]{The NTRU lattice \(\Lambda^q_h\)}
...
\begin{frame}[label={sec:orgbea7c1b}]{The NTRU lattice \(\Lambda^q_h\)}
\begin{itemize}
...
\begin{frame}[label={sec:orgfcde42e}]{NTRU}
...
\begin{frame}[label={sec:org160b35a}]{NTRU Applications}
...
\begin{frame}[label={sec:org0f239a3}]{Lattice Attacks}
\begin{itemize}
...
\begin{frame}[label={sec:org1eb6ca4}]{Best Attacks}
\begin{description}
...
\begin{frame}[label={sec:orgb5003c2}]{Lattice Reduction}
...
\label{sec:org6df4c2a}
\begin{frame}[label={sec:org35fc3e2}]{Overview}
\begin{displaymath} 
  \xymatrix{
    \K = \Q(ζ_m)   & & & \\
...
\begin{frame}[label={sec:orgb4aae10}]{1. Norming Down}
...
\begin{frame}[label={sec:org81f26ab}]{1. Norming Down}
...
\begin{frame}[label={sec:orgcc9c6e0}]{2. Lattice Reduction in the Subfield}
...
\begin{frame}[label={sec:org74fda9c}]{The Right Kind of \((x',y')\)}
