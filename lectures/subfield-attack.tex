...
\begin{frame}[label={sec:orge22db89}]{NTRU}
...
\begin{frame}[label={sec:org164215e}]{NTRU Applications}
...
\begin{frame}[label={sec:orgd641f62}]{Lattice Attacks}
\begin{itemize}
...
\item This requires strong lattice reduction and NTRU remains asymptotically secure.\footfullcite{HofPilSil98} \footfullcite{EPRINT:HPSSWZ15a}
\end{itemize}
\end{frame}

\begin{frame}[label={sec:org1a55b57}]{Best Attacks}
\begin{description}
\item[{Practical}] combined lattice-reduction and meet-in-the-middle attack \footfullcite{HofSilWhy06} of Howgrave-Graham. \footfullcite{C:HowgraveGraham07}
...
\begin{frame}[label={sec:orgd3f7f64}]{2. Lattice Reduction in the Subfield}
...
\begin{frame}[label={sec:org10f4b33}]{The Right Kind of \((x',y')\)}
