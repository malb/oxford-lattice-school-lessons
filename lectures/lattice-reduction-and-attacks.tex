...
\begin{frame}[label={sec:org5e011aa}]{root-Hermite Factors}
...
\begin{frame}[label={sec:org4d5cf91}]{Gaussian Heuristic}
...
\begin{frame}[label={sec:org69f8703}]{Geometric Series Assumption}
...
\begin{frame}[label={sec:org7e64afa}]{BKZ Quality}
...
\begin{frame}[label={sec:orga2d73ee}]{BKZ Quality}
\begin{tikzpicture}
...
\begin{frame}[label={sec:orgd9f33db}]{Running Time}
\begin{center}
...
\begin{frame}[label={sec:org8977de6}]{Running Time}
Per tour, BKZ calls 
\begin{description}
...
\begin{frame}[label={sec:org0c6fc4b}]{Choosing \(m\)}
...
\begin{frame}[label={sec:org51f45cc}]{Choosing \(ε\)}
\begin{tikzpicture}
\pgfplotsset{width=1.0\textwidth, height=0.5\textwidth}
...
\begin{frame}[label={sec:orga07d334}]{Choosing \(ε\)}
