...
\begin{frame}[label={sec:orgbbcf3da}]{BKZ Quality}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org6b8d797}]{Running Time}
\begin{center}
...
\begin{frame}[label={sec:org4c0d730}]{Running Time}
Per tour, BKZ calls 
\begin{description}
...
\begin{frame}[label={sec:orgcadc254}]{Choosing \(m\)}
...
\begin{frame}[label={sec:orga774413}]{Choosing \(ε\)}
\begin{tikzpicture}
\pgfplotsset{width=1.0\textwidth, height=0.5\textwidth}
...
\begin{frame}[label={sec:org8b459de}]{Choosing \(ε\)}
...
\begin{frame}[label={sec:org29f620b}]{Amortising Costs}
...
\begin{frame}[label={sec:org75f31c7}]{Small Secrets}
...
\begin{frame}[label={sec:org1c027e3}]{Honourable Mention: BKW}
\begin{columns}
