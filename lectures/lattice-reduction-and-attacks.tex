...
\begin{frame}[label={sec:org51e10a2}]{root-Hermite Factors}
...
\begin{frame}[label={sec:org358ed91}]{Gaussian Heuristic}
...
\begin{frame}[label={sec:org7cb6739}]{Geometric Series Assumption}
...
\begin{frame}[label={sec:org17f5fa0}]{BKZ Quality}
...
\begin{frame}[label={sec:org590c3cb}]{BKZ Quality}
\begin{tikzpicture}
...
\begin{frame}[label={sec:orga9324eb}]{Running Time}
\begin{center}
...
\begin{frame}[label={sec:org754a783}]{Running Time}
Per tour, BKZ calls 
\begin{description}
...
\begin{frame}[label={sec:org4d0aabc}]{Choosing \(m\)}
...
\begin{frame}[label={sec:org7cd4af9}]{Choosing \(ε\)}
\begin{tikzpicture}
\pgfplotsset{width=1.0\textwidth, height=0.5\textwidth}
...
\begin{frame}[label={sec:orgf8e39eb}]{Choosing \(ε\)}
