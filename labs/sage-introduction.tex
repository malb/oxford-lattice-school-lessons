...
\section{Sage}
\label{sec:org509afe3}
\begin{frame}[label={sec:org82921ab}]{Blurb}
\begin{columns}
...
\begin{frame}[fragile,label={sec:org866d776}]{How to use it}
 \begin{description}
...
\begin{frame}[label={sec:orgc74f3a8}]{Python \& Cython}
\begin{center}
\centering
\begin{center}
...
\begin{frame}[fragile,label={sec:org41e6e14}]{Dense Linear Algebra}
 \lstset{language=sage,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Lattices}
\label{sec:orgc66b4c6}
\begin{frame}[fragile,label={sec:orgdd46c86}]{Integer Matrices}
...
\begin{frame}[fragile,label={sec:org0341608}]{Bases for q-ary Lattices}
...
\begin{frame}[fragile,label={sec:org8b5cec7}]{Instance Generator}
...
\begin{frame}[fragile,label={sec:orgdc07522}]{LLL}
...
\begin{frame}[fragile,label={sec:orgaa27f9c}]{BKZ}
...
\begin{frame}[fragile,label={sec:org1c73f3b}]{Lattices}
...
\begin{frame}[fragile,label={sec:org45abcbe}]{Discrete Gaussians: Integers}
...
\begin{frame}[fragile,label={sec:orgc27591a}]{Discrete Gaussians: Lattices}
...
\begin{frame}[fragile,label={sec:org03fcda5}]{Learning with Errors}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:org3762ce0}]{Quotient Rings}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org38d128e}]{Number Fields}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgb07d7f6}]{Cyclotomic Number Fields}
...
\begin{frame}[fragile,label={sec:org13bd6cc}]{Cyclotomic Number Fields: Subfields}
...
\begin{frame}[fragile,label={sec:org9762986}]{Cyclotomic Number Fields: Galois Group}
...
\begin{frame}[fragile,label={sec:orgd623af0}]{Cyclotomic Number Fields: Class Group}
...
\begin{frame}[fragile,label={sec:orgb94f731}]{Cyclotomic Number Fields: Lattices}
 \begin{itemize}
...
\begin{frame}[standout,label={sec:org96e5e05}]{Fin}
\begin{center}
